						...
						<form action="{{route('update-profile')}}" method="post" enctype="multipart/form-data"
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input value="{{strtolower($admin->name)}}" type="text" name="name"
										   class="form-control has-feedback-left"
										   id="inputSuccess2" placeholder="Name">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input value="{{old('email')?old('email'):$admin->email}}" type="text" name="email"
					...
					<div class="x_content">
						<form action="{{route('update-password')}}" method="post"
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="password" name="old_password" class="form-control has-feedback-left"
										   id="inputSuccess2" placeholder="Old Password">
